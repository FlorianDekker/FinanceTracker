// ABN AMRO: tab-gescheiden .TAB/.TXT-export en de XLS/XLSX-export.
// Ongewijzigd overgenomen uit het oude src/utils/parsers.js; het gedrag moet
// identiek blijven aan wat er al in Florians database staat.
...
export async function parseABNExcel(file) {
  ...
  return parseABNExcelBuffer(buffer)
}

// Zelfde parser, maar met een al ingelezen ArrayBuffer (handig voor detectie/tests).
export function parseABNExcelBuffer(buffer) {
