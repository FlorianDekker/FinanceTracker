...
export const PROMPTS = {
  nl: {
    ...
    user: [
      ...
      '15. Neem in "discounts"."name" zoveel mogelijk de productnaam over zoals die op de bon staat (bijvoorbeeld "BONUS FUSILLI" in plaats van alleen "BONUS"): dat helpt de app de korting aan het juiste product te koppelen.',
    ].join('\n'),
  ...
  en: {
    ...
    user: [
      ...
      '15. In "discounts"."name", copy the product name as printed on the receipt whenever possible (e.g. "BONUS FUSILLI" instead of just "BONUS"): this helps the app link the discount to the right product.',
    ].join('\n'),
